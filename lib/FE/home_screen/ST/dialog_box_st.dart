...
import 'package:v2rp1/FE/home_screen/ST/stock_transfer.dart';
...
class CustomDialogBoxST extends StatefulWidget {
  final String title, descriptions, text, home;
  final Image img;

  const CustomDialogBoxST({
    Key? key,
    required this.title,
  ...
  @override
  _CustomDialogBoxSTState createState() => _CustomDialogBoxSTState();
}

class _CustomDialogBoxSTState extends State<CustomDialogBoxST> {
  @override
