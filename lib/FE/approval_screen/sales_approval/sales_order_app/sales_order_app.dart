...
class SalesOrderApproval extends StatefulWidget {
  SalesOrderApproval({Key? key}) : super(key: key);

  @override
  State<SalesOrderApproval> createState() => _SalesOrderApprovalState();
}
      ...
      child: isIOS
          ? CupertinoPageScaffold(
              navigationBar: CupertinoNavigationBar(
                ...
                middle: const Text("Sales Order Approval"),
                                          ...
                                          trailing: IconButton(
                                            ...
                                            onPressed: () {
                                              Get.to(SalesOrderApproval2(
                                                ...
                                                discount: _foundUsers[index]
                                                    ['header']['disc'],
                                                tax: _foundUsers[index]
                                                    ['header']['tax'],
                                                rate: _foundUsers[index]
                                                    ['header']['forex_rate'],
                                                notes: _foundUsers[index]
                                                    ['header']['reason'],
                                              ));
          ...
          : Scaffold(
              appBar: AppBar(
                title: const Text("Sales Order Approval"),
                centerTitle: true,
  ...
  Future<void> getDataa() async {
    ...
    try {
      ...
      var getData = await http.get(
        // Uri.http('156.67.217.113', '/api/v1/mobile/approval/salesorder'),
        Uri.https('v2rp.net', '/api/v1/mobile/approval/salesorder'),
        headers: {
