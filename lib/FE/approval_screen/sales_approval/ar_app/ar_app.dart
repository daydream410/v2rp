...
class ArApproval extends StatefulWidget {
  ArApproval({Key? key}) : super(key: key);

  @override
  State<ArApproval> createState() => _ArApprovalState();
}
  ...
  Future<void> getDataa() async {
    ...
    try {
      ...
      var getData = await http.get(
        // Uri.http('156.67.217.113', '/api/v1/mobile/approval/arreceipt/'),
        Uri.https('v2rp.net', '/api/v1/mobile/approval/arreceipt/'),
        headers: {
