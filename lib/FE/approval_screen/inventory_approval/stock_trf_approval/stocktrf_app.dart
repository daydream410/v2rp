...
import 'stocktrf_app2.dart';

class StockTrfApp extends StatefulWidget {
  StockTrfApp({Key? key}) : super(key: key);

  @override
  State<StockTrfApp> createState() => _StockTrfAppState();
}

class _StockTrfAppState extends State<StockTrfApp> {
                        ...
                        children: [
                          CupertinoSearchTextField(
                            controller: textControllers
                                .stocktransferAppController.value,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextField(
                          controller:
                              textControllers.stocktransferAppController.value,
                          onChanged: (value) => _runFilter(value),
  ...
  Future<void> getDataa() async {
    ...
    try {
      ...
      var getData = await http.get(
        // Uri.http('156.67.217.113', '/api/v1/mobile/approval/stocktransfer'),
        Uri.https('v2rp.net', '/api/v1/mobile/approval/stocktransfer'),
        headers: {
