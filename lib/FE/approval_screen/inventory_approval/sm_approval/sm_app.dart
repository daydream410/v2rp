                      ...
                      child: Column(
                        children: [
                          CupertinoSearchTextField(
                            controller: textControllers.smAppController.value,
  ...
  Future<void> getDataa() async {
    ...
    try {
      ...
      var getData = await http.get(
        ...
        Uri.https('v2rp.net', '/api/v1/mobile/approval/stockmovement'),
        headers: {
