...
class StockAdjApp extends StatefulWidget {
  StockAdjApp({Key? key}) : super(key: key);

  @override
  State<StockAdjApp> createState() => _StockAdjAppState();
}
      ...
      child: isIOS
          ? CupertinoPageScaffold(
              navigationBar: CupertinoNavigationBar(
                ...
                middle: const Text("Stock Adjustment Approval"),
                    ...
                    child: Column(
                      children: [
                        CupertinoSearchTextField(
                          controller:
                              textControllers.stockadjAppController.value,
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextField(
                        controller: textControllers.stockadjAppController.value,
                        onChanged: (value) => _runFilter(value),
  ...
  Future<void> getDataa() async {
    ...
    try {
      ...
      var getData = await http.get(
        ...
        Uri.https('v2rp.net', '/api/v1/mobile/approval/stockadjustment'),
        headers: {
