...
class StockTopupApp extends StatefulWidget {
  StockTopupApp({Key? key}) : super(key: key);

  @override
  State<StockTopupApp> createState() => _StockTopupAppState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: isIOS
                    ...
                    child: Column(
                      children: [
                        CupertinoSearchTextField(
                          controller:
                              textControllers.stocktopupAppController.value,
                                  ...
                                  onTap: () {
                                    Get.to(StockTopupApp2(
                                      ...
                                      reffno: _foundUsers[index]['header']
                                          ['reffno'],
                                      createdby: _foundUsers[index]['header']
                                          ['createdby'],
          ...
          : Scaffold(
              appBar: AppBar(
                title: const Text("Stock Top-up Approval"),
                centerTitle: true,
  ...
  Future<void> getDataa() async {
    ...
    try {
      ...
      var getData = await http.get(
        ...
        Uri.https('v2rp.net', '/api/v1/mobile/approval/stocktopup'),
        headers: {
