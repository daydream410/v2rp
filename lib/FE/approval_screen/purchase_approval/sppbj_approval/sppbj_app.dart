...
import 'package:v2rp1/FE/approval_screen/purchase_approval/sppbj_approval/sppbj_app2.dart';
...
class SppbjApp extends StatefulWidget {
  SppbjApp({Key? key}) : super(key: key);

  @override
  State<SppbjApp> createState() => _SppbjAppState();
}

class _SppbjAppState extends State<SppbjApp> {
                      ...
                      child: Column(
                        children: [
                          CupertinoSearchTextField(
                            controller:
                                textControllers.sppbjAppController.value,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextField(
                          controller: textControllers.sppbjAppController.value,
                          onChanged: (value) => _runFilter(value),
