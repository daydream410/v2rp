...
class SppbjConfirm extends StatefulWidget {
  SppbjConfirm({Key? key}) : super(key: key);

  @override
  State<SppbjConfirm> createState() => _SppbjConfirmState();
}
      ...
      child: isIOS
          ? CupertinoPageScaffold(
              navigationBar: CupertinoNavigationBar(
                ...
                middle: const Text("SPPBJ Confirmation"),
  ...
  Future<void> getDataa() async {
    ...
    try {
      ...
      var getData = await http.get(
        ...
        Uri.https('v2rp.net', '/api/v1/mobile/confirmation/sppbj/'),
        headers: {
