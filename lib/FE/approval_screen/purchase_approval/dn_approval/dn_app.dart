...
import 'package:v2rp1/FE/approval_screen/purchase_approval/dn_approval/dn_app2.dart';
...
class DebitNotesApp extends StatefulWidget {
  DebitNotesApp({Key? key}) : super(key: key);

  @override
  State<DebitNotesApp> createState() => _DebitNotesAppState();
}

class _DebitNotesAppState extends State<DebitNotesApp> {
      ...
      child: isIOS
          ? CupertinoPageScaffold(
              navigationBar: CupertinoNavigationBar(
                ...
                middle: const Text("D/N To Supplier Approval"),
                      ...
                      child: Column(
                        children: [
                          CupertinoSearchTextField(
                            controller:
                                textControllers.debitnotesAppController.value,
